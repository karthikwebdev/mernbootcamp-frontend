...
const StripeCheckout = (products) => {
    ...
    return (
        ...
        <div className="text-center">
           <h5 className="text-white">Stripe checkout: ${getFinalAmount(products)}</h5>
           {showStripeButton()}
        </div>
        </div>
    )
